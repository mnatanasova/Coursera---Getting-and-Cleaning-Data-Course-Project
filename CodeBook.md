...
3. Uses descriptive activity names to name the activities in the data set - merge activity_label and finalData.
4. Appropriately labels the data set with descriptive variable names - use gsub function to clean up the data labels.
5. From the data set in step 4, creates a second, independent tidy data set with the average of each variable for each activity and each subject - use aggregate function to create new tidyData.
